 ...
 * @subpackage M8wp_Integration/public
 */
...
class M8wp_Integration_Public {
	 ...
	 *
	 * @since    1.0.0
	 * @param      string    $m8wp_integration       The name of the plugin.
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->m8wp_integration, plugin_dir_url( __FILE__ ) . 'css/m8wp-integration-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->m8wp_integration, plugin_dir_url( __FILE__ ) . 'js/m8wp-integration-public.js', array( 'jquery' ), $this->version, false );
